<?php
    ...
    if (in_array($lang, ['he', 'en', 'es', 'ru', 'fr'])) {
            $_SESSION['lang'] = $lang;
        }
...
?>
						<div class="sites-select" style="position:relative;z-index:2">
							<input id="sid_input" onkeyup="filtersid(this,'#sid_list')" type="text" placeholder="<?=$sid? $sname[$sid] : "כל המתחמים"?>">
							<ul id="sid_list">
