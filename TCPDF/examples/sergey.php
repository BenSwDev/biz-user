...
?>
<style>
.text{color:#555;display:block;max-width:90%;width:100%;margin:0 auto;padding-top:3hv;text-align:center;line-height:1;direction:rtl}
.text .con{text-align:right}
.text .date{text-align:left;padding-top:5px;display:block}
ol{font-weight:500;display:block;box-sizing:border-box;padding:15px;direction:RTL}
ol li{padding-bottom:5px;direction:RTL}
ol li div{font-weight:400}
</style>
<?php
genContract(['numRooms' => 2, 'parking' => -1]);
?>


<table cellpadding="20" cellspacing="0"  style="width:100%;direction:ltr">
    <tbody>
		<tr>
			<td width="50%" align="left" style="text-align:right">
				<table width="100%" align="right">
					<tr><td><p>שם ראשון בעברית</p></td></tr>
					<tr><td><p>987654321</p></td></tr>
					<tr><td>&nbsp;</td></tr>
				</table>
				<img style="float:left" src="../../signature/1584921988_8695.png" alt="" title=""  width="100px"/>
			</td>
			<td width="50%" align="left" style="text-align:right">
				<table width="100%" align="right">
					<tr><td><p>שם שני בעברית</p></td></tr>
					<tr><td><p>987654321</p></td></tr>
					<tr><td>&nbsp;</td></tr>
				</table>
				<img style="float:left" src="../../signature/1585210827_0415.png" alt="" title=""  width="100px"/>
			</td>
...
$pdf->Output('example_sergey.pdf', 'I');
