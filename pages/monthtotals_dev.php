...
<div class="searchCms">
	<form method="GET" style="height:60px">
        <input type="hidden" name="page" value="monthtotals_dev" />
		<div class="inputWrap">
    		<select name="month">
<?php
...
?>
		...
		<div class="btnWrap">
            <a href="?page=monthtotals_dev">נקה</a>
...
<table id="monthtotals_table" class="bigDamnTable">
   ...
   <tbody id="sortRow">
<?php
    $masterUrl = ['page' => 'monthtotals_dev', 'month' => $selected];
    $sums = [];
    $mtc  = 0;
