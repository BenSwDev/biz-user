...
<section class="tfusa">
	...
	<div class="top-buttons">
		<a href="?page=calendar&date=<?=date("d/m/Y",strtotime("-1 month",strtotime($date)))?>" class="prev">חודש קודם</a>
		<div class="month-select">
			<select id="monthselect" onchange="window.location='index.php?page=calendar&monthView=<?=$monthView?>&date='+$(this).val()">
				<?
		...
		<a href="?page=calendar&date=<?=date("d/m/Y",strtotime("+1 month",strtotime($date)))?>" class="next">חודש הבא</a>
		<div class="clicks">
...
.tfusa .days-table{max-height:calc(100vh - 160px);overflow:auto}
