        ...
        if (count($rooms)){
            foreach($rooms as $room){
                ...
                <tr id="<?=$unit['unitID']?>">
					...
					<tD onclick="openPop(<?=$unit['unitID']?>,'')"><?=($unit['hasTreatments']?"<span style='color:green;'>כן</span>":"<span style='color:red;'>לא</span>")?><?=$unit['hasTreatments']? " (".$unit['maxTreatments'].")": "";?></tD>
