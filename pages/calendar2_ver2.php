...
<section class="tfusa">
	<div class='calendar-top cright'>
		...
		<div class="top-buttons">
			<a href="?page=calendar2_ver2&date=<?=date("d/m/Y",strtotime("-1 day",strtotime($date)))?>" class="prev">יום קודם</a>
			...
			<a href="?page=calendar2_ver2&date=<?=date("d/m/Y",strtotime("+1 day",strtotime($date)))?>" class="next">יום הבא</a>
		</div>
	</div>
	...
	<div class="days-table daily-view" id="days-table">
		<div class="r-side">
			<div class="top">
				<div class="row month">
...
function newload(){
		...
		if($('#monthview').val() ==2){
			...
			page= "calendar_ver2&monthView=1";
		}
